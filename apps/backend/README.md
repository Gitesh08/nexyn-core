<div align="center">
  <img src="https://raw.githubusercontent.com/cognee-ai/synapse-core/main/apps/frontend/public/synapse-logo.svg" alt="Synapse Logo" width="120" />
  <h1>Synapse Core</h1>
  <p><strong>A Biomimetic Memory Consolidation Layer for LLMs</strong></p>
  
  [![PyPI version](https://badge.fury.io/py/synapse-core.svg)](https://badge.fury.io/py/synapse-core)
  [![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](https://opensource.org/licenses/MIT)
</div>

<br />

Synapse Core is a lightweight, stateless Python library that introduces human-like memory consolidation to LLM applications. Built on top of [Cognee](https://github.com/topoteretes/cognee), Synapse acts as an intelligent intermediary layer that scores, decays, and prunes unstructured traces before they are permanently encoded into your knowledge graphs.
...
Synapse can be used as a standalone background API server, or imported programmatically into your existing AI applications.
...
You can bypass the server and use Synapse's core logic directly in your own scripts:

```python
import asyncio
from synapse import NormalizedPayload, WeightRegistry, QueueRegistry
...
By default, Synapse creates a lightweight SQLite database in your home directory (`~/.synapse/registry.db`) to track memory decay states.

For production deployments (or if you want to store it elsewhere), override the path using the environment variable:

```bash
export SYNAPSE_DB_PATH="/path/to/your/persistent/disk/synapse.db"
```
